...
export function StoreSettingsForm({ collections, initial }: StoreSettingsFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <ShowcaseSection title="Garanties (page d'accueil)" className="space-y-6 p-6.5!">
        <p className="text-body-xs text-dark-5 dark:text-dark-6">
          Les 4 encarts affichés sous la section collections de la page
          d&apos;accueil (icône, titre, sous-titre).
        </p>
