...
type ProductFormProps = {
  // Absent en édition (boutiqueId immuable après création) ; en création,
  // une seule option pour une vendeuse (sa boutique, présélectionnée), une
  // liste pour le staff plateforme.
