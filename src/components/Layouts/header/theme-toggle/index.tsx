...
export function ThemeToggleSwitch() {
  ...
  return (
    <button
      ...
      className="group cursor-pointer rounded-full bg-gray-3 p-1.25 text-dark outline-0 hover:outline-primary focus:outline-primary focus-visible:outline dark:bg-[#0d0c0a] dark:text-current"
    >
