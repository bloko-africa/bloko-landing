...
<h2>3. Commande</h2>
<p>La commande est passée directement sur le site. Le Client sélectionne les articles souhaités, les ajoute au panier puis valide sa commande en renseignant ses coordonnées. La confirmation de commande vaut acceptation des présentes CGV.</p>
<h2>4. Paiement</h2>
...
<p>Le Client dispose d'un délai de <strong>[Délai, ex : 7 jours]</strong> à compter de la réception du produit pour demander un échange ou un retour, à condition que l'article soit retourné dans son état d'origine <strong>[préciser selon le produit, ex : non porté et avec ses étiquettes pour un vêtement]</strong>. Les frais de retour sont à la charge du <strong>[Client / de la Boutique — à préciser]</strong>. Pour initier un retour, le Client contacte <strong>[Adresse e-mail ou numéro de contact]</strong>. Pour un produit périssable (alimentation), le droit de rétractation ne s'applique pas une fois la commande livrée.</p>
<h2>7. Garanties</h2>
